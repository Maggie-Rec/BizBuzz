        ...
        await Promise.all(
          ...
          for (let i = 0; i < processingArray[0].length; i++) {
            if (processingArray[0]._sum.capacity) {
              arr.push(
                (100 * processingArray[1]._sum.stock) /
                  processingArray[0]._sum.capacity
              );
            } else {
              arr.push(
                (100 * processingArray[0]._sum.stock) /
                  processingArray[1]._sum.capacity
              );
            }
          }
  ...
  return (
    <section id="container">
      ...
      <section id="data-display">
        {displayAsRadarChart === true ? <RadarChart data={data} /> : <></>}
      </section>
    </section>
  );
}
